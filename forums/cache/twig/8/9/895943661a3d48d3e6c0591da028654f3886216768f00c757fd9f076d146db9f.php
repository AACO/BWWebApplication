...
class __TwigTemplate_895943661a3d48d3e6c0591da028654f3886216768f00c757fd9f076d146db9f extends Twig_Template
{
...
";
        ...
        $this->loadTemplate("overall_footer.html", "acp_groups_position.html", 171)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
    }
